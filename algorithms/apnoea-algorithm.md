%%{init: {'theme':'default','flowchart':{'useMaxWidth':false},'themeVariables':{'fontSize':'28px','nodeSpacing':150,'rankSpacing':150}}}%%
...
P -->|Yes| Q["Consider Respiratory Stimulant Therapy<br>according to gestational age and local protocol"]:::treatment
